...
for fname in os.listdir(VAL_DIR):
    ...
    if "0_0" in filename:
        true_cls = "0"
    elif "1_0" in filename:
        true_cls = "1"
    elif "2_0" in filename:
        true_cls = "2"
    elif "3_0" in filename:
        true_cls = "3"
    elif "4_0" in filename:
        true_cls = "4"
    elif "5_0" in filename:
        true_cls = "5"
    elif "6_0" in filename:
        true_cls = "6"
    elif "7_0" in filename:
        true_cls = "7"
    elif "8_0" in filename:
        true_cls = "8"
    elif "9_0" in filename:
        true_cls = "9"
    else:
